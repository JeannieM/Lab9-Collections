...
public class Validator {
	...
	/**
	 * Get a Yes from the user. This was an example code-along in class and it doesn't make practical sense to me. I must be missing something
	 */
	public static boolean yesOrNo(Scanner scnr, String prompt) {
		...
		do {
			input = getString(scnr, prompt);//what is the purpose of this code? Question for Sam/Kyle/David
